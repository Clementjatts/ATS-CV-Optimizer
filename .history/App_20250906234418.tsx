...
const CvDisplay: React.FC<{ cvData: CvData }> = ({ cvData }) => {
  return (
    <div id="cv-preview" className="bg-white p-8 md:p-12 text-black font-[calibri] text-[11pt] leading-normal w-full max-w-4xl mx-auto">
      
      {/* PROFILE HEADER */}
      <header className="text-center border-b-2 border-gray-300 pb-6 mb-8">
        <h1 className="text-4xl font-bold text-gray-800 uppercase tracking-wide mb-2">{cvData.fullName}</h1>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-gray-800 uppercase tracking-wide border-b border-gray-400 pb-2 mb-4">
          Professional Summary
        </h2>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-gray-800 uppercase tracking-wide border-b border-gray-400 pb-2 mb-6">
          Professional Experience
        </h2>
...
export default function App() {
  ...
  const handleSaveAsPdf = () => {
    ...
    if (element && optimizedCvData) {
        ...
        const opt = {
            margin:       [0.3, 0.3, 0.3, 0.3], // Reduced margins for more content
        ...
        // Use a timeout to ensure the scroll position is set
        setTimeout(() => {
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200">
              ...
              <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-green-700 mb-2">🎯 Job Description Matching:</h4>
                    <div className="space-y-3">
                      <div>
                        <p className="text-xs font-semibold text-green-600 mb-1">Keywords Integrated:</p>
                      ...
                      <div>
                        <p className="text-xs font-semibold text-green-600 mb-1">Skills Aligned:</p>
                      ...
                      <div>
                        <p className="text-xs font-semibold text-green-600 mb-1">Experience Optimizations:</p>
                        <ul className="text-sm text-green-700 space-y-1">
                      ...
                      <div>
                        <p className="text-xs font-semibold text-green-600 mb-1">Summary Tailoring:</p>
                        <p className="text-sm text-green-700">{optimizedCvData.optimizationDetails.summaryTailoring}</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-semibold text-green-700 mb-2">📋 ATS Optimization:</h4>
                    <ul className="text-sm text-green-700 space-y-1">
