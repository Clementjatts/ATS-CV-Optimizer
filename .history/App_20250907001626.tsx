...
const CvDisplay: React.FC<{ cvData: CvData }> = ({ cvData }) => {
  return (
    <div id="cv-preview" className="bg-white p-8 md:p-12 text-black font-[calibri] text-[11pt] leading-normal w-full max-w-4xl mx-auto print:max-w-none print:p-4 print:mx-0">
