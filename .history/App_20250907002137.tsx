...
const CvDisplay: React.FC<{ cvData: CvData }> = ({ cvData }) => {
  return (
    <div id="cv-preview" className="bg-white p-6 md:p-8 text-black font-[calibri] text-[10pt] leading-normal w-full max-w-3xl mx-auto" style={{width: '210mm', minHeight: '297mm'}}>
...
export default function App() {
  ...
  const handleSaveAsPdf = () => {
    ...
    if (element && optimizedCvData) {
        ...
        // Temporarily modify the element for PDF generation
        ...
        const opt = {
            margin:       [0.3, 0.3, 0.3, 0.3], // A4 appropriate margins
        ...
        <div className="space-y-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200 flex flex-col">
             ...
             <div className="flex-grow bg-slate-200 rounded-md border border-slate-300 min-h-[40rem] flex flex-col overflow-hidden">
              {isLoading && (
                 <div className="flex items-center justify-center h-full w-full text-center text-slate-500">
