...
export default function App() {
  ...
  const handleSaveAsPdf = () => {
    ...
    if (element && optimizedCvData) {
        ...
        // Apply PDF-specific styling - no transforms, direct positioning
        ...
        // Center the content within the element
        const contentDiv = pdfElement.querySelector('div') as HTMLElement;
        if (contentDiv) {
