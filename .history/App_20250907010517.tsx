...
export default function App() {
  ...
  const handleSaveAsPdf = () => {
    ...
    if (element && optimizedCvData) {
        ...
        // Apply PDF-specific styling with proper centering
        ...
        const opt = {
            ...
            html2canvas: { 
                ...
                scrollX: 0,
                scrollY: 0,
                windowWidth: 1200, // Wider window to capture centered content
                windowHeight: 1600, // Taller window for full content
                allowTaint: true,
