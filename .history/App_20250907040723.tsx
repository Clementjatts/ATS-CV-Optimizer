...
export default function App() {
  ...
  const generatePdfPreview = async () => {
    ...
    try {
      ...
      // Apply PDF-specific styling while preserving content
      ...
      // Use the original element directly instead of cloning
  ...
  const handleSaveAsPdf = async () => {
    ...
    try {
      ...
      // Add the cloned element to the document temporarily for better rendering
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="space-y-12">
          ...
          {optimizedCvData && (
            <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200">
              <h2 className="text-xl font-semibold text-slate-800 mb-4">3. Optimization Summary</h2>
              <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg">
                <div className="flex items-start">
                  <CheckCircleIcon className="h-5 w-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="text-sm font-semibold text-green-800 mb-2">CV Successfully Optimized!</h3>
                    <div className="text-sm text-green-700 space-y-2">
                      <p>✓ <strong>Content Analysis:</strong> Your CV has been analyzed and tailored to match the job requirements</p>
                      <p>✓ <strong>Keyword Optimization:</strong> Relevant keywords from the job description have been incorporated</p>
                      <p>✓ <strong>ATS Compatibility:</strong> Formatted for optimal parsing by Applicant Tracking Systems</p>
                      <p>✓ <strong>Professional Layout:</strong> Clean, modern design that highlights your qualifications</p>
                      <p>✓ <strong>Skills Alignment:</strong> Your skills have been prioritized based on job requirements</p>
                      <p>✓ <strong>Experience Enhancement:</strong> Work experience descriptions optimized for impact</p>
                    </div>
                  </div>
                </div>
              </div>
