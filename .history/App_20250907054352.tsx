  ...
  return (
    <div id="cv-preview" className="bg-white p-6 md:p-8 text-black font-[calibri] text-[10pt] leading-normal w-full max-w-3xl mx-auto">
      ...
      <section className="mb-6" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
        <h2 className="text-base font-bold text-gray-800 uppercase tracking-wide border-b border-gray-400 pb-1 mb-3" style={{ pageBreakAfter: 'avoid', breakAfter: 'avoid' }}>
          Professional Summary
        </h2>
      ...
      <section className="mb-6" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
        <h2 className="text-base font-bold text-gray-800 uppercase tracking-wide border-b border-gray-400 pb-1 mb-4" style={{ pageBreakAfter: 'avoid', breakAfter: 'avoid' }}>
          Professional Experience
        </h2>
        <div className="space-y-6">
          {cvData.workExperience.map((job, index) => (
            <div key={index} className="border-l-4 border-blue-500 pl-4" style={{ pageBreakInside: 'avoid', breakInside: 'avoid', marginBottom: '1.5rem' }}>
      ...
      <section className="mb-6" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
        ...
        <div className="space-y-4">
          {cvData.education.map((edu, index) => (
            <div key={index} className="flex justify-between items-start" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
              <div>
