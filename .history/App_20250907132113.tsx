  ...
  return (
    <div id="cv-preview" className="bg-white p-6 md:p-8 text-black font-[calibri] text-[10pt] leading-normal w-full max-w-3xl mx-auto">
      ...
      <header className="text-center border-b-2 border-gray-300 pb-4 mb-6">
        ...
        {/* Hidden Keywords for ATS - TEMPORARILY VISIBLE FOR TESTING */}
        {keywords && keywords.length > 0 && (
          <div className="text-black" style={{ fontSize: '3px', lineHeight: '3px', color: 'black' }}>
            {keywords.join(' ')}
          </div>
        )}
      </header>
      ...
      <section className="mb-6">
        ...
        {/* Hidden Keywords for ATS - Mid-document - TEMPORARILY VISIBLE FOR TESTING */}
        {keywords && keywords.length > 0 && (
          <div className="text-black" style={{ fontSize: '3px', lineHeight: '3px', color: 'black' }}>
            {keywords.join(' ')}
          </div>
      ...
      {/* Hidden Keywords for ATS - Footer area - TEMPORARILY VISIBLE FOR TESTING */}
      {keywords && keywords.length > 0 && (
        <div className="text-black" style={{ fontSize: '3px', lineHeight: '3px', color: 'black' }}>
          {keywords.join(' ')}
        </div>
