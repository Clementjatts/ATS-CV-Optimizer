...
const CvDisplay: React.FC<{ cvData: CvData; keywords?: string[] }> = ({ cvData, keywords }) => {
  return (
    <div id="cv-preview" className="bg-white p-6 md:p-8 text-black font-[calibri] text-[10pt] leading-normal w-full max-w-3xl mx-auto" style={{
      ...
      <section className="mb-6" style={{
        ...
        <p className="text-gray-700 leading-relaxed text-justify" style={{
          pageBreakInside: 'avoid',
          breakInside: 'avoid'
        }}>{cvData.professionalSummary}</p>
      ...
      <section className="mb-6" style={{
        ...
        <div className="space-y-6">
          {cvData.workExperience.map((job, index) => (
            <div key={index} className="border-l-4 border-blue-500 pl-4" style={{
              pageBreakInside: 'avoid',
              breakInside: 'avoid'
            }}>
              ...
              <ul className="space-y-1">
                {job.responsibilities.map((resp, i) => (
                  <li key={i} className="text-sm text-gray-700 flex items-start" style={{
                    pageBreakInside: 'avoid',
                    breakInside: 'avoid'
                  }}>
      ...
      <section className="mb-6" style={{
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-1">
          {cvData.skills.map((skill, index) => (
            <div key={index} className="text-sm text-gray-700 flex items-start" style={{
              pageBreakInside: 'avoid',
              breakInside: 'avoid'
            }}>
              <span className="text-blue-500 mr-2 mt-1">•</span>
...
export default function App() {
  ...
  const generatePdfPreview = async () => {
    ...
    try {
      ...
      // Simple and reliable approach - use original element with proper settings
      const opt = {
        margin: 0.5,
        ...
        html2canvas: {
          ...
          scrollX: 0,
          scrollY: 0,
          x: Math.max(0, (element.scrollWidth - 475) / 2),
          y: 0,
        ...
        pagebreak: {
          ...
          avoid: ['li', 'p', 'div', 'span', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6']
        }
      };
                      ...
                      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-xl border border-blue-100">
                        ...
                        <ul className="space-y-2 text-sm text-blue-700">
                          <li className="flex items-start gap-2">
                            ...
                            <span>Clean, scannable format for ATS systems</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-blue-500 mt-1">•</span>
                            <span>Standard section headers for easy parsing</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-blue-500 mt-1">•</span>
                            <span>Consistent formatting and structure</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-5 rounded-xl border border-purple-100">
                        ...
                        <ul className="space-y-2 text-sm text-purple-700">
                          <li className="flex items-start gap-2">
                            ...
                            <span>Professional language and action verbs</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-purple-500 mt-1">•</span>
                            <span>Quantified achievements where possible</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-purple-500 mt-1">•</span>
                        ...
                        <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-5 rounded-xl border border-amber-100">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {optimizedCvData.optimizationDetails.keywordsIntegrated.map((keyword, index) => (
                              <span key={index} className="bg-gradient-to-r from-amber-200 to-yellow-200 text-amber-800 px-3 py-1.5 rounded-full text-xs font-semibold border border-amber-300 shadow-sm">
                                {keyword}
                              </span>
                            ))}
                          </div>
