              ...
              <div className="mt-6 space-y-4">
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-emerald-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-emerald-700 transition-colors duration-200"
                  >
