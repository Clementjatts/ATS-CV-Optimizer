                    ...
                    <div className="p-4 border-t border-slate-200">
                      <form onSubmit={(e) => {
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-emerald-600 text-white rounded-md text-sm font-medium hover:bg-emerald-700 disabled:bg-slate-400 disabled:cursor-not-allowed transition-colors duration-200"
                        >
                          Send
                        </button>
                      </form>
