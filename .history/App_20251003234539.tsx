  ...
  return (
    <div>
      ...
      <div
        ...
        onDrop={handleDrop}
        className={`relative w-full p-4 border-2 border-dashed rounded-lg transition-colors duration-200 h-24 flex flex-col items-center justify-center text-center
