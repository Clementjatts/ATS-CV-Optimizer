          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-slate-500 font-medium">AI-Powered Resume Enhancement</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-2">
              <span className="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-semibold rounded-full">AI-Powered</span>
              <span className="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">ATS Compatible</span>
              <span className="px-3 py-1 bg-purple-100 text-purple-700 text-xs font-semibold rounded-full">Instant Results</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-white/95 via-purple-50/95 to-pink-50/95 backdrop-blur-sm p-6 rounded-xl shadow-xl border border-purple-200/50 hover:shadow-2xl transition-all duration-300">
              <h2 className="text-xl font-semibold text-slate-800 mb-4">1. Provide Your Details</h2>
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-gradient-to-b from-blue-400 to-purple-500 p-4 rounded-r-lg mb-6 text-sm text-blue-800 flex items-start shadow-sm">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold py-2 px-4 rounded-lg shadow-lg hover:shadow-xl hover:from-indigo-700 hover:to-purple-700 disabled:bg-slate-400 disabled:cursor-not-allowed transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform hover:scale-[1.02] disabled:transform-none"
              >
                {isLoading ? (
                  <>
                    <LoadingSpinner />
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 flex flex-col">
            <h2 className="text-xl font-semibold text-slate-800 mb-4">2. Your Optimized CV</h2>
            <div className="flex-grow bg-gradient-to-br from-slate-100 to-slate-200 rounded-xl border border-slate-300/50 min-h-[40rem] flex flex-col overflow-hidden shadow-inner">
              {isLoading && (
              ...
              <div className="mt-6 space-y-4">
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold py-2 px-4 rounded-xl shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-cyan-700 disabled:bg-slate-400 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.02] disabled:transform-none"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold py-2 px-4 rounded-xl shadow-lg hover:shadow-xl hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 transform hover:scale-[1.02]"
                  >
                    <SparkleIcon className="h-4 w-4" />
                ...
                {/* AI Chat Interface */}
                {isChatOpen && (
                  <div className="bg-white/95 backdrop-blur-sm border border-white/30 rounded-xl shadow-lg">
                    ...
                    {/* Chat Messages */}
                    <div className="h-64 overflow-y-auto p-4 space-y-3 bg-gradient-to-br from-slate-50 to-slate-100">
                    ...
                    <div className="p-4 border-t border-slate-200">
                      <form onSubmit={(e) => {
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl text-sm font-medium hover:from-emerald-700 hover:to-teal-700 disabled:bg-slate-400 disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] disabled:transform-none"
                        >
                          Send
                        </button>
                      </form>
          ...
          {optimizedCvData && (
            <div className="bg-gradient-to-br from-white/95 to-slate-50/95 p-8 rounded-2xl shadow-xl border border-white/30 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
              {/* Header */}
              <div className="flex items-center gap-3 mb-8">
                <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-600 rounded-xl flex items-center justify-center shadow-lg">
                  <span className="text-white text-lg font-bold">3</span>
                </div>
                <h2 className="text-2xl font-bold text-slate-800 tracking-tight">Optimization Analysis</h2>
              </div>
