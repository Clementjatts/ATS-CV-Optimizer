    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-100 relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="space-y-12">
          ...
          {optimizedCvData && (
            <div className="bg-gradient-to-br from-white/95 via-emerald-50/95 to-teal-50/95 p-8 rounded-2xl shadow-xl border border-emerald-200/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
              {/* Header */}
