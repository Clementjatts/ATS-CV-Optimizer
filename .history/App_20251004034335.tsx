    ...
    try {
      ...
      if (useDatabaseCV && selectedCVFromDB) {
        ...
        if ('content' in selectedCVFromDB) {
          ...
          // It's an uploaded file - download and parse it
          const uploadedFile = selectedCVFromDB as UploadedFile;
          try {
            console.log('Downloading file from:', uploadedFile.downloadURL);
            ...
            if (error instanceof Error) {
              ...
              throw new Error('Failed to download and parse the uploaded file. Please try uploading the file again.');
            }
          }
        }
