    ...
    it('should handle workflow with different CV data structures', () => {
      const cvVariations = [
        // Minimal CV
        {
          ...
          certifications: [],
          optimizationDetails: {
            keywordsIntegrated: ['JavaScript'],
            skillsAligned: [],
            experienceOptimizations: [],
            summaryTailoring: 'Software developer'
          }
        },
        // Complex CV
        {
          ...
          optimizationDetails: {
            keywordsIntegrated: ['computer science', 'artificial intelligence'],
            skillsAligned: ['research', 'academic'],
            experienceOptimizations: ['Distinguished researcher'],
            summaryTailoring: 'Distinguished researcher and academic'
          }
        }
      ];
