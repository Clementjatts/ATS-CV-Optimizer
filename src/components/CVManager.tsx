...
const CVManager: React.FC<CVManagerProps> = ({
  ...
  const [, setShowSaveForm] = useState(false);
  ...
  const filterCVs = useCallback(() => {
    const currentData: CVSource[] = activeTab === 'optimized' ? savedCVs : uploadedFiles;
    let filtered: CVSource[] = currentData;
  ...
  }, [activeTab, savedCVs, uploadedFiles, searchTerm]);
      ...
      <div className='bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden'>
        ...
        <div className='bg-gradient-to-r from-purple-600 to-pink-600 p-6 text-white'>
          <div className='flex items-center justify-between'>
            <div>
              <h2 id='cv-manager-title' className='text-2xl font-bold'>
                CV Database
              </h2>
              ...
              <div className='max-h-96 overflow-y-auto pr-2'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  {filteredCVs.map((item) => {
                    ...
                    const isSelected = selectedCVs.some(
                      (selected) =>
                    ...
                    return (
                      <div
                        key={item.id}
                        className={`bg-gradient-to-br from-white to-purple-50 border rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105 ${
                            ...
                            <>
                              <div className='flex items-center gap-2'>
                                <span className='text-lg'>
                                  {fileStorageService.getFileTypeIcon(file.fileType)}
                                </span>
