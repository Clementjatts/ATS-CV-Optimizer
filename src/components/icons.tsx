...
export const FileIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap='round'
      strokeLinejoin='round'
      d='M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12.75h4.5m-4.5 3H12m-1.5-6h1.5m-1.5 3h1.5M3 17.25V5.25A2.25 2.25 0 015.25 3h9.75a2.25 2.25 0 011.591.659l2.25 2.25a2.25 2.25 0 01.659 1.591v9.75a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 17.25z'
    />
  </svg>
);
